...
export async function migrate(db:Database){
 await db.transaction().execute(async tx=>{
  ...
  for(const [index,name] of ['001_foundation','002_runtime','003_telemetry','004_lifecycle','005_native','006_activation','007_operations','008_measurement','009_optimization','010_durable_ingest','011_activation_backfill','012_retention','013_experiment_outcomes','014_weekly_summary','015_suggestion_feedback','016_member_journey','017_interaction_health','018_interaction_pairs','019_weekly_phases','020_audit_actor','021_helper_alerts'].entries()){
