...
export async function lifecyclePanel(issue:Issue,metrics:Metrics,locale:UiLocale='en'):Promise<Panel>{return nexusPanel({title:t(locale,'lifecycle.title'),subtitle:t(locale,'lifecycle.subtitle'),children:[divider(),
